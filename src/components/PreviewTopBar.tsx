...
const PreviewTopBar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] flex items-center justify-between px-5 md:px-8 py-2.5"
      style={{ backgroundColor: "hsl(210, 13%, 15%)", color: "hsl(0, 0%, 100%)" }}
    >
